...
const CONFIG = {
  ...
  STARTER_LOGO: '/images/starter/ryzan/ryzan_banner_bold_b_192x92.svg', // 普通logo图片 示例：/images/starter/logo/logo.svg
  STARTER_LOGO_WHITE: '/images/starter/ryzan/ryzan_banner_bold_w_192x92.svg', // 透明底浅色logo 示例： /images/starter/logo/logo-white.svg
  ...
  STARTER_HERO_BUTTON_1_TEXT: '关于锐赞', // 英雄区按钮
  STARTER_HERO_BUTTON_1_URL: 'https://ryzanedu.com', // 英雄区按钮
  STARTER_HERO_BUTTON_1_ICON: '/images/starter/ryzan/ryzan_logo_bold_b_13x24.svg', // 英雄区按钮1的图标，不需要则留空
  ...
  STARTER_HERO_PREVIEW_IMAGE: '/images/starter/ryzan/ryzan_main.webp', // 产品预览图 ，默认读取public目录下图片
